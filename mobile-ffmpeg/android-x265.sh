...
export ANDROID_NDK_ROOT=/Users/zuguorui/Library/Android/sdk/ndk/21.4.7075529
export ARCH=arm64-v8a
export API=26
export BASEDIR="$(pwd)"
export TOOLCHAIN=darwin-x86_64
...
# ${SED_INLINE} 's/gnu++98/c++11/g' $SOURCE_PATH/source/CMakeLists.txt

echo CFLAGS=$CFLAGS
echo CXXFLAGS=$CXXFLAGS
echo LDFLAGS=$LDFLAGS
echo ARCH_OPTIONS=$ARCH_OPTIONS
echo ARCH=$ARCH
